                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <label for="avatar" class="col-md-4 col-form-label text-md-end">{{ __('Image')
                                }}</label>

                            <div class="col-md-6">
                                <input type="file" name="avatar" class="form-control"> {{-- <input type="file" class="form-control" name="avatar"> --}} @error('avatar')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span> @enderror
                            </div>
